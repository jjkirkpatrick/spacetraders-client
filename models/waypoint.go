...
const (
	...
	AstroidField          WaypointType = "ASTROID_FIELD"
	Astroid               WaypointType = "ASTROID"
	EngineeredAstroid     WaypointType = "ENGINEERED_ASTROID"
	AstroidBase           WaypointType = "ASTROID_BASE"
